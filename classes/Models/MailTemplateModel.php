...
class MailTemplateModel extends Model
{
    ...
    {
        return $query->where('channel_type', 'mail');
    }
    ...
    {
        return $this->mail()->where('id', $id)->first();
    }
     ...
     */
    public function getTemplateContentByCode($code, $plugin = null)
    {
     ...
     * @return array|bool template_id, template_content
     */
    public function getTemplateIdByCode($code, $plugin = null)
    {
        $data = $this->getTemplateByCode($code, $plugin);
