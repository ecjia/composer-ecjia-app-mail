...
return array(
    ...
    'directory'   => 'mail',
    'name'        => __('邮件', 'mail'),
    'description' => __('邮件应用以“电子邮件为主要的网站推广手段”为核心功能打造开发，针对商城用户对商品订阅、关注来接收最新邮件动态，而商家则可以对促销，打折，红包、杂志等促销信息对全体、指定（等级）用户进行邮件群发推送，并且可以实时关注邮件发送队列的进度。', 'mail'),
    'author'      => 'ECJIA TEAM',
